# Fullstack APP Project - CRUD Task List with deploy in AWS

## Technologies

React.js | Node.js | Javascript | Express | DynamoDB | Lambda | Amplify
...
### DynamoDB functions (Create, Read, Update, Delete)
